...
class YbomCrawlerTest {
    ...
    void testCfDecodeEmail() { // A
        assertEquals("rooti@rpg.sega.co", YbomCrawler.decodeCfEmail("cbb9a4a4bfa28bb9bbace5b8aeacaae5a8a4"));
    }
    ...
    @BeforeEach
    void setUp() {
        YbomCrawler.developers = new LinkedHashMap<>();
    }

    @Test
    void testCreditsA() { // A
        Element td = getTd(CREDITS1);
        Assertions.assertEquals("45166=Ayako Mori", toString(YbomCrawler.parseCredits(td)));
        assertEquals("{45166=Ayako Mori}", YbomCrawler.developers.toString());
    }
    ...
    void testCreditsAAA() { // A A A
        ...
        Assertions.assertEquals("45166=Ayako Mori, 55535=Hideo Kodzima, 12345=Eric Chahi", toString(YbomCrawler.parseCredits(td)));
        assertEquals("{45166=Ayako Mori, 55535=Hideo Kodzima, 12345=Eric Chahi}", YbomCrawler.developers.toString());
    }

    @Test
    void testCreditsT() { // t
        Element td = getTd("Duke Nukem");
        Assertions.assertEquals("Duke Nukem", toString(YbomCrawler.parseCredits(td)));
        assertEquals("{}", YbomCrawler.developers.toString());
    }

    @Test
    void testCreditsAt() { // A (t)
        Element td = getTd(CREDITS1 + " (John Doe)");
        Assertions.assertEquals("45166=Ayako Mori (John Doe)", toString(YbomCrawler.parseCredits(td)));
        assertEquals("{45166=Ayako Mori}", YbomCrawler.developers.toString());
    }
    ...
    void testCreditsTt() { // t, t
        ...
        Assertions.assertEquals("name1, name2", toString(YbomCrawler.parseCredits(td)));
        assertEquals("{}", YbomCrawler.developers.toString());
    }
    ...
    void testCreditsTtAt() { // t, t, A (t)
        ...
        Assertions.assertEquals("name1, name2, 45166=Ayako Mori (name3)", toString(YbomCrawler.parseCredits(td)));
        assertEquals("{45166=Ayako Mori}", YbomCrawler.developers.toString());
    }
    ...
    void testCreditsTtt() { // t, t (t)
        ...
        Assertions.assertEquals("name1, name2 (group2)", toString(YbomCrawler.parseCredits(td)));
        assertEquals("{}", YbomCrawler.developers.toString());
    }
    ...
    void testCreditsAtAt() { // A (t), A (t)
        ...
        Assertions.assertEquals("45166=Ayako Mori (name1), 55535=Hideo Kodzima (name2)", toString(YbomCrawler.parseCredits(td)));
        assertEquals("{45166=Ayako Mori, 55535=Hideo Kodzima}", YbomCrawler.developers.toString());
    }
    ...
    void testCreditsAttAtttt() { // A (t), t, A (t [t]), t [t]
        ...
        Assertions.assertEquals("45166=Ayako Mori (origName1), name2, 55535=Hideo Kodzima (origName3 [group3]), name4 [origName4]", toString(YbomCrawler.parseCredits(td)));
        assertEquals("{45166=Ayako Mori, 55535=Hideo Kodzima}", YbomCrawler.developers.toString());
    }
    ...
    void testCreditsAtt() { // A (t [t] )  Rieko Kodama (Phoenix Rie [フェニックスりえ])
        ...
        Assertions.assertEquals("45166=Ayako Mori (name [group])", toString(YbomCrawler.parseCredits(td)));
        assertEquals("{45166=Ayako Mori}", YbomCrawler.developers.toString());
    }
    ...
    void testCreditsTT() { // t [t]
        ...
        Assertions.assertEquals("name [origName]", toString(YbomCrawler.parseCredits(td)));
        assertEquals("{}", YbomCrawler.developers.toString());
    }
    ...
    void testCreditsTTAt() { // t [t], A (t)
        ...
        Assertions.assertEquals("name [origName], 45166=Ayako Mori (origName2)", toString(YbomCrawler.parseCredits(td)));
        assertEquals("{45166=Ayako Mori}", YbomCrawler.developers.toString());
    }
    ...
    void testCreditsttATtATt() { // t, t, A (T (t) ), A (T (t) )
        ...
        Assertions.assertEquals("name1, name2, 45166=Ayako Mori (origName3 (note3)), 55535=Hideo Kodzima (origName4 (note4))", toString(YbomCrawler.parseCredits(td)));
        assertEquals("{45166=Ayako Mori, 55535=Hideo Kodzima}", YbomCrawler.developers.toString());
    }
    ...
    void testCreditsATty() { // A (T [t]/Y)
        ...
        Assertions.assertEquals("45166=Ayako Mori (origName3 [note3] /Yup)", toString(YbomCrawler.parseCredits(td)));
        assertEquals("{45166=Ayako Mori}", YbomCrawler.developers.toString());
    }
    ...
    void testCreditsRiverTop() { // (River Top/Kawasaki Minoru [リバートップ/かわさき みのる])
        ...
        Assertions.assertEquals("45166=Ayako Mori (River Top/Kawasaki Minoru [リバートップ/かわさき みのる])", toString(YbomCrawler.parseCredits(td)));
        assertEquals("{45166=Ayako Mori}", YbomCrawler.developers.toString());
    }
    ...
    void testCreditsEncryptedEmail() { // Bug-Bug, rooti@rpg.sega.co
        ...
        Assertions.assertEquals("Bug-Bug, rooti@rpg.sega.co", toString(YbomCrawler.parseCredits(td)));
        assertEquals("{}", YbomCrawler.developers.toString());
    }
    ...
    void testCreditsOgawan() { // Ogawan [Soon to go 'puff-puff' in Hawaii [おがわん] [もうすぐ ハワイでパフパフ]]
        ...
        Assertions.assertEquals("Ogawan [Soon to go 'puff-puff' in Hawaii [おがわん] [もうすぐ ハワイでパフパフ]]", toString(YbomCrawler.parseCredits(td)));
        assertEquals("{}", YbomCrawler.developers.toString());
    }
    ...
    void testCreditsKaeru() { // Kaeru Taniguchi (Shacho Kwaeru [Feeling?] [くわえる　しゃちょー　[って　かんじ？])
        ...
        Assertions.assertEquals("45166=Ayako Mori (Shacho Kwaeru [Feeling?] [くわえる　しゃちょー　 [って　かんじ？]])", toString(YbomCrawler.parseCredits(td)));
        assertEquals("{45166=Ayako Mori}", YbomCrawler.developers.toString());
    }
    ...
    void testCreditsKao() { // Kao [sucking in bike] [かお [バイクで　すってん]]
        ...
        Assertions.assertEquals("Kao [sucking in bike] [かお [バイクで　すってん]]", toString(YbomCrawler.parseCredits(td)));
        assertEquals("{}", YbomCrawler.developers.toString());
    }
    ...
    void testCreditsNorihiko() { // Norihiko Togashi (Noririn♪ -and sound- [の　り　り　ん　♪ [や　お　と　が])
        ...
        Assertions.assertEquals("45166=Ayako Mori (Noririn♪ -and sound- [の　り　り　ん　♪ [や　お　と　が]])", toString(YbomCrawler.parseCredits(td)));
        assertEquals("{45166=Ayako Mori}", YbomCrawler.developers.toString());
    }
    ...
    void testCreditsFuncom() { // Erik Gløersen (of FUNCOM Productions [Oslo, Norway])
        ...
        Assertions.assertEquals("45166=Ayako Mori (of FUNCOM Productions [Oslo]), Norway", toString(YbomCrawler.parseCredits(td)));
        assertEquals("{45166=Ayako Mori}", YbomCrawler.developers.toString());
    }
    ...
    void testCredits4x() { // <a href="http://www.4xtechnologies.com">http://www.4xtechnologies.com</a>
        ...
        Assertions.assertEquals("http://www.4xtechnologies.com", toString(YbomCrawler.parseCredits(td)));
        assertEquals("{}", YbomCrawler.developers.toString());
    }
