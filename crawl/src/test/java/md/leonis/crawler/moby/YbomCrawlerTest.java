...
class YbomCrawlerTest {
    ...
    private YbomCrawler crawler;
    
    @Test
    //   r o o t i . r p g . s e g a . c o
    // cbb9a4a4bfa28bb9bbace5b8aeacaae5a8a4
    void testCfDecodeEmail() { // A
        assertEquals("rooti@rpg.sega.co", crawler.decodeCfEmail("cbb9a4a4bfa28bb9bbace5b8aeacaae5a8a4"));
    }
    ...
    void testCreditsA() { // A
        ...
        Assertions.assertEquals("45166=Ayako Mori", toString(crawler.parseCredits(td)));
        assertEquals("{45166=Ayako Mori}", crawler.getDevelopers().toString());
    }
    ...
    void testCreditsAAA() { // A A A
        ...
        Assertions.assertEquals("45166=Ayako Mori, 55535=Hideo Kodzima, 12345=Eric Chahi", toString(crawler.parseCredits(td)));
        assertEquals("{45166=Ayako Mori, 55535=Hideo Kodzima, 12345=Eric Chahi}", crawler.getDevelopers().toString());
    }

    @Test
    void testCreditsT() { // t
        Element td = getTd("Duke Nukem");
        Assertions.assertEquals("Duke Nukem", toString(crawler.parseCredits(td)));
        assertEquals("{}", crawler.getDevelopers().toString());
    }

    @Test
    void testCreditsAt() { // A (t)
        Element td = getTd(CREDITS1 + " (John Doe)");
        Assertions.assertEquals("45166=Ayako Mori (John Doe)", toString(crawler.parseCredits(td)));
        assertEquals("{45166=Ayako Mori}", crawler.getDevelopers().toString());
    }
    ...
    void testCreditsTt() { // t, t
        ...
        Assertions.assertEquals("name1, name2", toString(crawler.parseCredits(td)));
        assertEquals("{}", crawler.getDevelopers().toString());
    }
    ...
    void testCreditsTtAt() { // t, t, A (t)
        ...
        Assertions.assertEquals("name1, name2, 45166=Ayako Mori (name3)", toString(crawler.parseCredits(td)));
        assertEquals("{45166=Ayako Mori}", crawler.getDevelopers().toString());
    }
    ...
    void testCreditsTtt() { // t, t (t)
        ...
        Assertions.assertEquals("name1, name2 (group2)", toString(crawler.parseCredits(td)));
        assertEquals("{}", crawler.getDevelopers().toString());
    }
    ...
    void testCreditsAtAt() { // A (t), A (t)
        ...
        Assertions.assertEquals("45166=Ayako Mori (name1), 55535=Hideo Kodzima (name2)", toString(crawler.parseCredits(td)));
        assertEquals("{45166=Ayako Mori, 55535=Hideo Kodzima}", crawler.getDevelopers().toString());
    }
    ...
    void testCreditsAttAtttt() { // A (t), t, A (t [t]), t [t]
        ...
        Assertions.assertEquals("45166=Ayako Mori (origName1), name2, 55535=Hideo Kodzima (origName3 [group3]), name4 [origName4]", toString(crawler.parseCredits(td)));
        assertEquals("{45166=Ayako Mori, 55535=Hideo Kodzima}", crawler.getDevelopers().toString());
    }
    ...
    void testCreditsAtt() { // A (t [t] )  Rieko Kodama (Phoenix Rie [フェニックスりえ])
        ...
        Assertions.assertEquals("45166=Ayako Mori (name [group])", toString(crawler.parseCredits(td)));
        assertEquals("{45166=Ayako Mori}", crawler.getDevelopers().toString());
    }
    ...
    void testCreditsTT() { // t [t]
        ...
        Assertions.assertEquals("name [origName]", toString(crawler.parseCredits(td)));
        assertEquals("{}", crawler.getDevelopers().toString());
    }
    ...
    void testCreditsTTAt() { // t [t], A (t)
        ...
        Assertions.assertEquals("name [origName], 45166=Ayako Mori (origName2)", toString(crawler.parseCredits(td)));
        assertEquals("{45166=Ayako Mori}", crawler.getDevelopers().toString());
    }
    ...
    void testCreditsttATtATt() { // t, t, A (T (t) ), A (T (t) )
        ...
        Assertions.assertEquals("name1, name2, 45166=Ayako Mori (origName3 (note3)), 55535=Hideo Kodzima (origName4 (note4))", toString(crawler.parseCredits(td)));
        assertEquals("{45166=Ayako Mori, 55535=Hideo Kodzima}", crawler.getDevelopers().toString());
    }
    ...
    void testCreditsATty() { // A (T [t]/Y)
        ...
        Assertions.assertEquals("45166=Ayako Mori (origName3 [note3] /Yup)", toString(crawler.parseCredits(td)));
        assertEquals("{45166=Ayako Mori}", crawler.getDevelopers().toString());
    }
    ...
    void testCreditsRiverTop() { // (River Top/Kawasaki Minoru [リバートップ/かわさき みのる])
        ...
        Assertions.assertEquals("45166=Ayako Mori (River Top/Kawasaki Minoru [リバートップ/かわさき みのる])", toString(crawler.parseCredits(td)));
        assertEquals("{45166=Ayako Mori}", crawler.getDevelopers().toString());
    }
    ...
    void testCreditsEncryptedEmail() { // Bug-Bug, rooti@rpg.sega.co
        ...
        Assertions.assertEquals("Bug-Bug, rooti@rpg.sega.co", toString(crawler.parseCredits(td)));
        assertEquals("{}", crawler.getDevelopers().toString());
    }
    ...
    void testCreditsOgawan() { // Ogawan [Soon to go 'puff-puff' in Hawaii [おがわん] [もうすぐ ハワイでパフパフ]]
        ...
        Assertions.assertEquals("Ogawan [Soon to go 'puff-puff' in Hawaii [おがわん] [もうすぐ ハワイでパフパフ]]", toString(crawler.parseCredits(td)));
        assertEquals("{}", crawler.getDevelopers().toString());
    }
    ...
    void testCreditsKaeru() { // Kaeru Taniguchi (Shacho Kwaeru [Feeling?] [くわえる　しゃちょー　[って　かんじ？])
        ...
        Assertions.assertEquals("45166=Ayako Mori (Shacho Kwaeru [Feeling?] [くわえる　しゃちょー　 [って　かんじ？]])", toString(crawler.parseCredits(td)));
        assertEquals("{45166=Ayako Mori}", crawler.getDevelopers().toString());
    }
    ...
    void testCreditsKao() { // Kao [sucking in bike] [かお [バイクで　すってん]]
        ...
        Assertions.assertEquals("Kao [sucking in bike] [かお [バイクで　すってん]]", toString(crawler.parseCredits(td)));
        assertEquals("{}", crawler.getDevelopers().toString());
    }
    ...
    void testCreditsNorihiko() { // Norihiko Togashi (Noririn♪ -and sound- [の　り　り　ん　♪ [や　お　と　が])
        ...
        Assertions.assertEquals("45166=Ayako Mori (Noririn♪ -and sound- [の　り　り　ん　♪ [や　お　と　が]])", toString(crawler.parseCredits(td)));
        assertEquals("{45166=Ayako Mori}", crawler.getDevelopers().toString());
    }
    ...
    void testCreditsFuncom() { // Erik Gløersen (of FUNCOM Productions [Oslo, Norway])
        ...
        Assertions.assertEquals("45166=Ayako Mori (of FUNCOM Productions [Oslo]), Norway", toString(crawler.parseCredits(td)));
        assertEquals("{45166=Ayako Mori}", crawler.getDevelopers().toString());
    }
    ...
    void testCredits4x() { // <a href="http://www.4xtechnologies.com">http://www.4xtechnologies.com</a>
        ...
        Assertions.assertEquals("http://www.4xtechnologies.com", toString(crawler.parseCredits(td)));
        assertEquals("{}", crawler.getDevelopers().toString());
    }
